...
function display(mydata){
  let p = mydata.map(function(value){
...
let b = data.map(function(value){
  return `<button class="company-btn" onclick="filterbtn()">${value.company}</button>`
})

document.getElementById("companies").innerHTML = b.join("");


function filterbtn(company){
